...
class Patient(BaseModel):
    ...
    name : Annotated[str, Field(..., description="Name of the patient", examples=['Elon Musk'])]
...
def view_patient(patient_id : str = Path(..., description='ID of the patient of the DB', examples='P001')):
    #load all the data
    data = load_data()
